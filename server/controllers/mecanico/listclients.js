...
module.exports = async( {body}, res ) => {
    ...
    var sql='select s.fechaingreso, e.fecha_actualizacion, e.estado from reg_servicio s INNER JOIN estado e on s.idReg=e.id_servicio where s.id_moto="'+placa+'" and s.id_trabajador="'+mec+'"'
